...
export function DestinationList({ destinations, onAskQuestion }: DestinationListProps) {
    ...
    return (
      <div className="mt-8 text-center">
        <Alert variant="default" className="max-w-md mx-auto bg-secondary/50">
          ...
          <AlertTitle className="font-headline text-xl">No Recommendations Yet</AlertTitle>
          <AlertDescription>
            Fill out the preferences form above to get personalized travel destination ideas!
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  return (
    <div className="mt-12">
      <h2 className="text-4xl font-headline text-center mb-8 text-primary">Your Personalized Destinations</h2>
